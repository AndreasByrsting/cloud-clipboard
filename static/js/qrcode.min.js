/**
 * QR Code Generator for JavaScript - Compact Edition
 * Based on qrcode-generator (MIT License)
 * Renders QR code into a container element using Canvas
 */
var QRCode = (function () {
  //------------------------------------------------------------------------
      ...
      for (var col = 0; col < moduleCount; col++) {
        ...
        for (var r = -1; r <= 1; r++)
          for (var c = -1; c <= 1; c++) {
            ...
            if (nr < 0 || nc < 0 || nr >= moduleCount || nc >= moduleCount) continue;
            if (dark === qrCode.isDark(nr, nc)) sameCount++;
          }
  ...
  QRCodeModel.prototype = {
    ...
    make: function () {
      if (this.typeNumber < 1) {
        ...
        for (; typeNumber < 40; typeNumber++) {
          ...
          buffer.put(4, 4); // mode indicator
          buffer.put(this.dataList.length, 8); // character count
          for (var i = 0; i < this.dataList.length; i++) this.dataList[i].write(buffer);
    ...
    mapData: function (data, maskPattern) {
      var inc = -1, row = this.moduleCount - 1;
      var bitIndex = 7, byteIndex = 0;
  ...
  QRCode.prototype.makeCode = function (text) {
    this._qrCode = new QRCodeModel(0, this._options.correctLevel);
  ...
  QRCode.prototype.makeImage = function () {
    if (typeof this._options.width !== "number" || typeof this._options.height !== "number")
      return;
    var moduleCount = this._qrCode.getModuleCount();
    ...
    for (var row = 0; row < moduleCount; row++) {
      for (var col = 0; col < moduleCount; col++) {
        ctx.fillStyle = this._qrCode.isDark(row, col)
